...
class OfferViewHelper extends IntangibleViewHelper
{
    public function initializeArguments()
    {
        ...
        $this->registerArgument('addOn', 'mixed', 'An additional offer that can only be obtained in combination with the first base offer (e.g. supplements and extensions that are available for a surcharge).');
        ...
        $this->registerArgument('offeredBy', 'mixed', 'A pointer to the organization or person making the offer.');
        ...
        $this->registerArgument('priceValidUntil', 'mixed', 'The date after which the price is no longer available.');

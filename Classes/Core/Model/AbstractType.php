    ...
    protected function addAdditionalProperties(): void
    {
        ...
        if ($additionalProperties === false) {
            ...
            if ($event->haveAdditionalPropertiesRegistered()) {
                $message = \sprintf(
                    'Using the RegisterAdditionalTypePropertiesEvent for "%s" is deprecated since EXT:schema version 3.10.0, it will be removed in version 4.0. To register additional properties create a class implementing AdditionalPropertiesInterface. Consult the docs for details.',
                    $this->getType(),
                );

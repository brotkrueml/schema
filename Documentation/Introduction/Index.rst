...
`JSON-LD <https://json-ld.org/>`_ markup and can be checked with Google's
`Structured Data Testing Tool <https://search.google.com/structured-data/testing-tool>`_
and `Rich Results Test <https://search.google.com/test/rich-results>`_.

There are also browser extensions available which ease the testing of the
markup, e.g.
`Structured Data Testing Tool <https://chrome.google.com/webstore/detail/structured-data-testing-t/kfdjeigpgagildmolfanniafmplnplpl>`_
for Chrome.
